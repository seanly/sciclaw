...
func createToolRegistry(workspace string, restrict bool, cfg *config.Config, msgBus *bus.MessageBus) *tools.ToolRegistry {
	...
	pdfFormInspectTool := tools.NewPDFFormInspectTool(workspace, restrict)
	pdfFormInspectTool.SetSharedWorkspacePolicy(sharedWorkspace, sharedReadOnly)
	pdfFormSchemaTool := tools.NewPDFFormSchemaTool(workspace, restrict)
	pdfFormSchemaTool.SetSharedWorkspacePolicy(sharedWorkspace, sharedReadOnly)
	...
	registry.Register(pdfFormInspectTool)
	registry.Register(pdfFormSchemaTool)
	registry.Register(pdfFormFillTool)
